...
import './FolderPaperLogin.scss';

const FolderPaperLogin = () => {
    return (
        ...
        <div className="form-inner">
          ...
          <div className="btn-group">
            <button className="btn btn--primary">Sign in</button><a className="btn--text" href="#0">Forgot password?</a>
          </div>
        </div>
      </form>
...
export default FolderPaperLogin;
